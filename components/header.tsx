      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="w-7 h-7 bg-primary rounded-lg flex items-center justify-center font-black text-primary-foreground text-base shadow-lg shadow-primary/20 group-hover:scale-110 transition-transform italic">A</div>
            <span className="font-black text-base text-foreground uppercase italic tracking-tighter">AutoCAD<span className="text-primary">Store</span></span>
          </Link>
